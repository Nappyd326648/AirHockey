package com.example.nappy.airhockey;
...
import com.example.nappy.airhockey.util.LoggerConfig;
import com.example.nappy.airhockey.util.ShaderHelper;
import com.example.nappy.airhockey.util.TextResourceReader;
...
public class AirHockeyRender implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config){
        ...
        String vertexShaderSource = TextResourceReader.
                readTextFileFromResource(context,R.raw.
